...
class AndroidDependencyModelJsonAdapter(
    ...
    private val listOfSingleDependencyAdapter: JsonAdapter<List<SingleDependency>> =
        moshi.adapter(
            Types.newParameterizedType(List::class.java, SingleDependency::class.java),
            emptySet(), "single"
        )

    private val listOfGroupDependencyAdapter: JsonAdapter<List<GroupDependency>> =
        moshi.adapter(
            Types.newParameterizedType(List::class.java, GroupDependency::class.java),
            emptySet(), "group"
        )
    ...
    override fun fromJson(reader: JsonReader): AndroidDependencyModel {
        ...
        while (reader.hasNext()) {
            when (reader.selectName(options)) {
                0 -> version = stringAdapter.fromJson(reader) ?: throw Util.unexpectedNull(
                    "version",
                    "version", reader
                )
