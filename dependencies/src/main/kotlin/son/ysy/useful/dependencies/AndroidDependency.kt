...
abstract class AndroidDependency private constructor(
  ...
  val version: String
    ...
    object Single {
         ...
         */
        object Activity : AndroidDependency("androidx.activity", "activity-ktx", "1.2.1")
         ...
         */
        object Appcompat : AndroidDependency("androidx.appcompat", "appcompat", "1.3.0-beta01")
    ...
    sealed class Core(
      ...
      version: String
        ...
        object Ktx : Core("core-ktx", "1.5.0-beta03")
    ...
    sealed class Coroutines(
      module: String
    ) : AndroidDependency("org.jetbrains.kotlinx", module, "1.4.3") {
    ...
    sealed class DialogX(
      module: String
    ) : AndroidDependency("com.kongzue.dialogx", module, "0.0.33") {
    ...
    sealed class Epoxy(
      module: String
    ) : AndroidDependency("com.airbnb.android", module, "4.4.3") {
    ...
    sealed class Fragment(
      module: String
    ) : AndroidDependency("androidx.fragment", module, "1.3.1") {
    ...
    sealed class Room(
      module: String
    ) : AndroidDependency("androidx.room", module, "2.3.0-beta03") {
