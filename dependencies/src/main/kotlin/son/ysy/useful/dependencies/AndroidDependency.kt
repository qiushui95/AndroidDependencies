...
abstract class AndroidDependency private constructor(
    ...
    sealed class DialogX(
        ...
        object KongzueStyle : DialogX("com.kongzue.dialogx.style.kongzue", "DialogXKongzueStyle")
    ...
    sealed class Fragment(
        ...
        object Core : Fragment("androidx.fragment", "fragment", "1.3.3")

        /**
         * https://github.com/terrakok/Cicerone
         */
        object Manager : Fragment("com.github.terrakok", "cicerone", "7.0")

        object Test : Fragment("androidx.fragment", "fragment-testing", "1.3.3")
    }
